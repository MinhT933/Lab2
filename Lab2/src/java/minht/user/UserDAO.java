...
public class UserDAO {
        ...
        try {
            ...
            if (cn != null) {
                String sql = "  select [userID], \n"
                        ...
                        + "		 [userName], \n"
                        + "		 [email], [phone], \n"
                        + "		 u.[photo], r.[roleID], r.[roleName], s.[statusID], s.[statusName] \n"
                        + "		 from [Users] u, [Roles] r, [Status] s \n"
 ...
 public ArrayList<UserDTO> getAllUserFilter(String nameSearch, String roleName) throws SQLException, NamingException {
    ...
    public boolean updateStatusbyUserID(String userID, int statusID ) throws NamingException, SQLException {
         boolean flag = false;
        try {
            cn = DBHelper.getConnection();
            if (cn != null) {
